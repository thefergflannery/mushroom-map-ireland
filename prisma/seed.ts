...
const irishSpecies = [
  ...
  },
  {
    ...
    commonEn: 'Cultivated Mushroom / Button Mushroom',
    commonGa: 'Muisiriún Saothraithe',
    slug: 'cultivated-mushroom',
    edibility: 'EDIBLE' as Edibility,
    season: 'Year-round (cultivated)',
    habitat: 'Grassland, gardens (also cultivated)',
    keyTraits: 'White or brown cap; pink gills becoming dark brown; white stem; very common cultivated species',
    sensitive: false,
  },
  {
    latinName: 'Cantharellus amethysteus',
    commonEn: 'Amethyst Chanterelle',
    commonGa: 'Cantaral Aimitis',
    slug: 'amethyst-chanterelle',
    edibility: 'CHOICE' as Edibility,
    season: 'Summer to autumn (July-November)',
    habitat: 'Mixed woodland',
    keyTraits: 'Yellow-orange cap with purple scales; false gills; fruity smell; excellent edible',
    sensitive: false,
  },
  {
    latinName: 'Lactarius deterrimus',
    commonEn: 'False Saffron Milk Cap',
    commonGa: 'Bainne Dearg Bréige',
    slug: 'false-saffron-milk-cap',
    edibility: 'EDIBLE' as Edibility,
    season: 'Autumn (August-November)',
    habitat: 'Under spruce trees',
    keyTraits: 'Orange cap; orange milk turning green; edible but bitter',
    sensitive: false,
  },
  {
    latinName: 'Macrolepiota rhacodes',
    commonEn: 'Shaggy Parasol',
    commonGa: 'Paraisóil Fionnach',
    slug: 'shaggy-parasol',
    edibility: 'EDIBLE' as Edibility,
    season: 'Late summer to autumn (July-November)',
    habitat: 'Woodland, gardens, parks',
    keyTraits: 'Scaly brown cap on tall stem; bruising red; edible but causes upset in some people',
    sensitive: false,
  },
  {
    latinName: 'Russula xerampelina',
    commonEn: 'Crab Brittlegill',
    commonGa: 'Rúisile Pórtán',
    slug: 'crab-brittlegill',
    edibility: 'EDIBLE' as Edibility,
    season: 'Late summer to autumn (August-November)',
    habitat: 'Coniferous and mixed woodland',
    keyTraits: 'Purple-reddish cap; white to cream gills; crab smell when old; good edible',
    sensitive: false,
  },
  {
    latinName: 'Volvariella bombycina',
    commonEn: 'Silky Rosegill',
    commonGa: 'Gill Rós Síoda',
    slug: 'silky-rosegill',
    edibility: 'EDIBLE' as Edibility,
    season: 'Summer to autumn (July-October)',
    habitat: 'Dead and dying hardwood trees',
    keyTraits: 'White silky cap; pink gills; volva at base; rare but good edible',
    sensitive: false,
  },
  {
    latinName: 'Marasmius oreades',
    commonEn: 'Fairy Ring Champignon',
    commonGa: 'Cuilbheach Fáinne na Sióga',
    slug: 'fairy-ring-champignon',
    edibility: 'EDIBLE' as Edibility,
    season: 'Summer to autumn (June-November)',
    habitat: 'Grassland, lawns, forming fairy rings',
    keyTraits: 'Tan cap; widely spaced gills; tough stem; grows in rings; excellent edible',
    sensitive: false,
  },
  {
    latinName: 'Pluteus cervinus',
    commonEn: 'Deer Shield',
    commonGa: 'Sciath Fhia',
    slug: 'deer-shield',
    edibility: 'EDIBLE' as Edibility,
    season: 'Year-round',
    habitat: 'Dead hardwood logs and stumps',
    keyTraits: 'Brown cap with darker center; pink gills; white stem; good edible',
    sensitive: false,
  },
  {
    latinName: 'Pleurotus cornucopiae',
    commonEn: 'Branching Oyster',
    commonGa: 'Oisrí Craobhach',
    slug: 'branching-oyster',
    edibility: 'EDIBLE' as Edibility,
    season: 'Autumn to spring (October-April)',
    habitat: 'Dead hardwood trees',
    keyTraits: 'Fan-shaped to funnel-shaped; pale grey-brown; grows in clusters; good edible',
    sensitive: false,
  },
  {
    latinName: 'Agaricus xanthoderma',
    commonEn: 'Yellow-staining Mushroom',
    commonGa: 'Beacán Buí-Chlórach',
    slug: 'yellow-staining-mushroom',
    edibility: 'TOXIC' as Edibility,
    season: 'Summer to autumn (July-November)',
    habitat: 'Woodland, gardens, parks',
    keyTraits: 'White cap; stains yellow when bruised; unpleasant chemical smell; causes gastrointestinal upset',
    sensitive: false,
  },
  {
    latinName: 'Galerina marginata',
    commonEn: 'Funeral Bell',
    commonGa: 'Clog Sochraide',
    slug: 'funeral-bell',
    edibility: 'DEADLY' as Edibility,
    season: 'Year-round',
    habitat: 'Dead conifer wood',
    keyTraits: 'Brown cap; brown gills; ring on stem; DEADLY - contains same toxins as Death Cap',
    sensitive: true,
  },
  {
    latinName: 'Cortinarius orellanus',
    commonEn: 'Fool\'s Webcap',
    commonGa: 'Caipín Breallach an Amadáin',
    slug: 'fools-webcap',
    edibility: 'DEADLY' as Edibility,
    season: 'Autumn (September-November)',
    habitat: 'Beech and oak woodland',
    keyTraits: 'Orange-brown cap; orange gills; slow-acting kidney toxin - DEADLY',
    sensitive: true,
  },
  {
    latinName: 'Inocybe erubescens',
    commonEn: 'Deadly Fibrecap',
    commonGa: 'Fíbre-Caipín Marfach',
    slug: 'deadly-fibrecap',
    edibility: 'DEADLY' as Edibility,
    season: 'Spring to summer (May-August)',
    habitat: 'Beech woodland, gardens',
    keyTraits: 'White to pink-brown cap with radial fibers; white stem; muscarine poisoning - DEADLY',
    sensitive: true,
  },
  {
    latinName: 'Hebeloma sinapizans',
    commonEn: 'Poison Pie',
    commonGa: 'Pióg Nimhe',
    slug: 'poison-pie',
    edibility: 'TOXIC' as Edibility,
    season: 'Autumn (September-November)',
    habitat: 'Mixed woodland',
    keyTraits: 'Large tan-brown cap; cream gills; radish smell; causes severe gastrointestinal upset',
    sensitive: false,
  },
  {
    latinName: 'Suillus bovinus',
    commonEn: 'Jersey Cow Bolete',
    commonGa: 'Boileatán Bó',
    slug: 'jersey-cow-bolete',
    edibility: 'EDIBLE' as Edibility,
    season: 'Autumn (September-November)',
    habitat: 'Under pine trees',
    keyTraits: 'Yellow-brown cap; yellow pores; short stem; slimy when wet; edible but not highly regarded',
    sensitive: false,
  },
  {
    latinName: 'Xerocomus subtomentosus',
    commonEn: 'Suede Bolete',
    commonGa: 'Boileatán Sued',
    slug: 'suede-bolete',
    edibility: 'EDIBLE' as Edibility,
    season: 'Summer to autumn (July-November)',
    habitat: 'Mixed woodland',
    keyTraits: 'Olive-brown velvety cap; yellow pores; good edible',
    sensitive: false,
  },
  {
    latinName: 'Ramaria formosa',
    commonEn: 'Coral Fungus',
    commonGa: 'Fungais Coireal',
    slug: 'coral-fungus',
    edibility: 'TOXIC' as Edibility,
    season: 'Autumn (September-November)',
    habitat: 'Mixed woodland',
    keyTraits: 'Pink-orange coral-like branches; causes gastrointestinal upset',
    sensitive: false,
  },
  {
    latinName: 'Calocera viscosa',
    commonEn: 'Yellow Stagshorn',
    commonGa: 'Fhiadh-Adharc Buí',
    slug: 'yellow-stagshorn',
    edibility: 'UNKNOWN' as Edibility,
    season: 'Year-round',
    habitat: 'Dead conifer wood',
    keyTraits: 'Bright yellow gelatinous antler-like growths; inedible',
    sensitive: false,
  },
  {
    latinName: 'Scleroderma citrinum',
    commonEn: 'Common Earthball',
    commonGa: 'Domhainliathán Coiteann',
    slug: 'common-earthball',
    edibility: 'TOXIC' as Edibility,
    season: 'Summer to autumn (July-November)',
    habitat: 'Woodland, heathland',
    keyTraits: 'Brown warty ball; black interior; poisonous - not a true puffball',
    sensitive: false,
  },
  {
    latinName: 'Mycena haematopus',
    commonEn: 'Bleeding Bonnet',
    commonGa: 'Cochaillín Fola',
    slug: 'bleeding-bonnet',
    edibility: 'UNKNOWN' as Edibility,
    season: 'Autumn (September-November)',
    habitat: 'Dead hardwood logs',
    keyTraits: 'Red-brown cap; exudes red juice when damaged; inedible',
    sensitive: false,
  },
];
